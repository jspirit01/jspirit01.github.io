<template>
  ...
  >
    ...
    <div class="left-pannel">
      <img :src="picture" />
      <div class="subtitle" style="font-weight:700; margin-top:1.5rem"><span>About me</span></div>
      <div class="bio-list">
        <div class="bio-line">
...
export default {
  ...
  methods: {
    open(link) {
      switch (link) {
        case "scholar":
          window.open(this.scholar, "_blank");
          break;
        case "github":
