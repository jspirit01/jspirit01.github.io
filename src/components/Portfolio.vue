<template>
  ...
  <!-- <div class="project-list">
    <div class="project-line" 
      ...
      <div class="title">Sondam Rhythm Game</div>
      <div class="authors">Youjin Choi & <u>JooYeong Kim</u>, Jin-Hyuk hong</div>
      <div class="journal">IEEE Transaction on Affective Computing</div>
    </div>
  </div> -->
